    ...
    <div className="w-full">
      <div className='bg-gray-200 mt-3 text-slate-700'>
        <div className='flex w-8/12 mx-auto justify-between'>
          <div className='font-bold text-md'>Terms & Condition</div>
          <div className='font-bold text-md'>Home/Terms & Condition</div>
        </div>
      </div>
      <div className='w-8/12 justify-between mt-20 flex items-start mx-auto'>
        <div className='w-[60%]'>
          <div>
            ...
            <div className='text-slate-600 mt-3 text-md flex flex-col gap-2'>
              <ul><span className='text-slate-900 text-md'>Purpose:</span> This platform fosters student collaboration for academic support, facilitating the exchange of knowledge and assistance.</ul>
              <ul><span className='text-slate-900 text-md'>Responsibility:</span> Users commit to sharing accurate and ethical content, ensuring the reliability and integrity of information exchanged.</ul>
              <ul><span className='text-slate-900 text-md'>Guidelines:</span> Content must align with educational objectives, respect intellectual property, and maintain a conducive learning environment.</ul>
              <ul><span className='text-slate-900 text-md'>Enforcement:</span> We reserve the right to moderate and terminate accounts violating these terms to uphold community standards and ensure a positive user experience.</ul>
            </div>
          </div>
          <div>
            ...
            <p className='text-slate-600 mt-3 text-md gap-2'>
          ...
          <div>
            ...
            <p className='text-slate-600 mt-3 text-md gap-2 mb-10'>
        ...
        <div className=''>
          <div className='flex flex-col gap-1 border-l-[3px] border-slate-200 pl-4'>
            <div className='text-md text-slate-600 uppercase'>Table Of Content</div>
            <div className='text-md text-slate-700 font-semibold'>01. Terms & Condition</div>
            <div className='text-md text-slate-700 font-semibold'>02. Eligibility & Use</div>
            <div className='text-md text-slate-700 font-semibold'>03. Security and Limitation of Liability</div>
            <div className='text-md text-slate-700 font-semibold'>04. Termination</div>
          </div>
        </div>
      </div>
    </div>
