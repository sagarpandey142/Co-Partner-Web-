    ...
    <div className=' w-11/12 mx-auto mt-9'>
      <div className='w-12/12 flex flex-wrap gap-3 justify-start'>
        {currentCards.slice(0.9).map((data, index) => {
          ...
          return (
            <div key={actualIndex} className='bg-white w-[15rem] sm:w-[25rem] p-2 flex flex-col cursor-pointer'>
                  ...
                  <div className='mt-2 flex flex-col gap-2 ml-7'>
                    <div className='text-md text-slate-800 font-bold w-11/12'>{truncateString(data?.projectName,30)}</div>
                     <div className=' flex flex-wrap gap-2 items-center'>
                         ...
                         <div>
                              <p className=' text-slate-500 text-sm flex flex-wrap gap-1'>Level Of Experience : <div className='text-slate-800 font-bold'>{data.BasicDetail.LevelExperience}</div></p>
                         </div>
                     </div>
                  </div>
                  <div className='flex flex-wrap justify-between mt-4 text-md font-semibold mb-4 ml-7'>
                    <div className='flex flex-wrap gap-2 items-center'>
                      <div>
