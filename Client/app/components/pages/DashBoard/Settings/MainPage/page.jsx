...
const Page = (  ) => {
    ...
    return (
        <div>
            <div className='p-20 w-[140%] h-[100%] border-l-[3px] border-gray-200'>
                <p className='text-slate-800 text-xl font-semibold'>Settings</p>
                {/* Tabs */}
                <div className='mt-6 flex gap-10 border-b-[3px] border-slate-300 pb-3'>
                    {TabsArray.map((data, index) => (
                        <div
                            ...
                            className={`flex gap-2 items-center text-md cursor-pointer transition-all duration-300 ease-in-out ${clickable === index ? "text-blue-700 font-semibold " : "text-slate-500 border-transparent"}`}
                        >
